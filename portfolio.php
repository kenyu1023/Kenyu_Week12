    ...
    if (!db_connect()) {
        ...
        if ($numberOfRows > 0) {
            while ($row = mysqli_fetch_assoc($queryResult)) {
                ...
                echo "<input type='hidden' value='".$subImg."' id='subImage".$id."'>";
                echo "<input type='hidden' value='".$embed."' id='embed".$id."'>";
...
<div class="modalbox-style" id="modalBox">
    <div class="modalbox-info-style">
        <a data-fancybox="gallery" id="fancyBoxShowImage" href=""><img id='portImg' src='' alt="fasfassdfadsf"></a>
        <div class="sub-images" id="subImages">
            
        </div>
        <div id="portfolioEmbed">
